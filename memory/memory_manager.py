...
_TRIVIAL_PATTERNS = [
    r"^(hi|hello|hey|yo|sup|hiya)\b.{0,15}$",
    r"^what'?s up\b.{0,15}$",
    r"^how are you\b.{0,15}$",
    r"^good (morning|night|afternoon|evening)\b.{0,15}$",
    r"^(thanks|thank you|thx)\b.{0,15}$",
    r"^(ok(ay)?|cool|nice|great|got it|sure|alright)\.?$",
    r"^(bye|goodbye|see you|later)\b.{0,15}$",
]
